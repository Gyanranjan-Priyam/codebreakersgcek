...
import CreateSessionDialog from "@/app/admin/attendance/_components/create-session-dialog";
import SessionsTable from "@/app/admin/attendance/_components/sessions-table";
import StudentQRScanner from "@/app/admin/attendance/_components/student-qr-scanner";
import DelegatedScannerSheet from "@/app/admin/attendance/_components/delegated-scanner-sheet";
...
export default function CoAdminAttendancePage() {
  ...
  return (
    <div className="flex flex-col gap-6 p-4 sm:p-6 w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Create sessions, generate delegation codes, and scan student QR codes
          </p>
        </div>
      ...
      {/* Attendance Sessions Table (Delete disabled for Co-Admin) */}
      <Card>
          ...
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <CardDescription className="mt-1">
                Select active scanner session or view attendance counts.
              </CardDescription>
            </div>
