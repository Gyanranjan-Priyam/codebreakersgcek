...
import { getQuizByQuizId } from "@/app/admin/quizzes/actions";
import SystemsManagementView from "@/app/admin/quizzes/[quizId]/systems/_components/systems-management-view";

export default async function CoAdminSystemRegistrationPage({
  params,
}: {
  ...
  // Natural alphanumeric sorting by systemNumber
  systems.sort((a, b) =>
