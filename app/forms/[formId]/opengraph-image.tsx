...
export const alt = "CodeBreakers Form Preview";
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function Image({
  ...
  // Gradient / theme color for the top bar
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Second Question Mockup Card (Peek below, exactly like Google Forms preview) */}
        <div
          style={{
            width: "920px",
            marginTop: "16px",
