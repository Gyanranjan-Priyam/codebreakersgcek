...
import { getAdminRoadmapById, getAdminRoadmaps } from "../actions";
import { AdminStudioEditor } from "@/components/roadmaps/admin-studio-editor";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Roadmap Visual Studio | Admin Panel",
};

export const dynamic = "force-dynamic";

interface AdminRoadmapStudioPageProps {
  params: Promise<{ roadmapId: string }>;
}

export default async function AdminRoadmapStudioPage({ params }: AdminRoadmapStudioPageProps) {
