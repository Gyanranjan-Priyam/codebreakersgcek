    ...
    <div className="flex flex-col gap-6 p-4 sm:p-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Track top performers based on attendance, tasks, events, and quiz points
        </p>
      </div>
        ...
        <TabsContent value="overall" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                All-time leaderboard based on total points from all activities
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="monthly" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Leaderboard for selected month based on points from all activities
              </CardDescription>
            </CardHeader>
            <CardContent>
              <MonthlyLeaderboard 
